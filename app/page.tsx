...
const WORKFLOWS = [
  ...
  },
  {
    ...
    subtitle: 'Building & Structural Change Detection',
    description: 'Compare multi-temporal optical image pairs with trained Siamese U-Net models to detect building and structural changes. Unsupported sensors and domains are explicitly flagged.',
