...
TOOL_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "available",
        "version": "0.3.0-p0",
        "description": "Generates structured, natural-language remote-sensing captions and scene descriptions using the domain-adapted VLM.",
    },
    {
        "id": "rs_grounding",
    ...
    },
    {
        ...
        "status": "available",
        "version": "0.3.0-p0",
        "description": "Change detection for bi-temporal image pairs. Executes Siamese U-Net neural checkpoint trained on LEVIR-CD or CPU classical differencing.",
    },
    {
        "id": "change_vqa",
    ...
    },
    {
        ...
        "status": "available",
        "version": "0.3.0-p0",
        "description": "Multi-sensor cross-modal engine. Computes SAR radar backscatter physics (dB scale, roughness, specular/double-bounce return), synthesizes false-color composites, and executes joint VLM reasoning.",
    },
    {
        "id": "spatial_analyzer",
